...
List<ModelSound> getModelSoundList() {
  ...
  // model.setRightPositionIncrease(9.0);
  // list.add(model);
  // model = ModelSound();
  // model.setSoundId(11);
  // model.setHafizId(1);
  ...
  // model.setRightPositionIncrease(7.6);
  // list.add(model);
  // model = ModelSound();
  // model.setSoundId(12);
  // model.setHafizId(1);
  ...
  // model.setRightPositionIncrease(7.0);
  // list.add(model);
  // model = ModelSound();
  // model.setSoundId(13);
  // model.setHafizId(1);
  ...
  // model.setRightPositionIncrease(9.4);
  // list.add(model);
  // model = ModelSound();
  // model.setSoundId(19);
  // model.setHafizId(1);
  ...
  // model.setRightPositionIncrease(7.2);
  // list.add(model);
  // model = ModelSound();
  // model.setSoundId(20);
  // model.setHafizId(1);
  ...
  // model.setRightPositionIncrease(8.0);
  // list.add(model);
